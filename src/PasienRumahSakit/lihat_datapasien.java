...
public class lihat_datapasien extends javax.swing.JFrame {
     ...
     */
    Connection connection; //membut objek koneksi
    public static String no_pendaftaran; //mendeklarasikan variable no_pendaftaran
    ...
    public lihat_datapasien() {
        ...
        try{
            //code untuk mengambil data (menampilkan data) dari table data_pasien
            ...
            while(rs.next()){
                _no.setText(rs.getString(1));//menampilkan teks yang diambil dari kolom tabel no_pendaftaran ke dalam text field _no
                _namapasien.setText(rs.getString(2));//menampilkan teks yang diambil dari kolom tabel nama_pasien ke dalam text field _namapasien
                _alamat.setText(rs.getString(3));//menampilkan teks yang diambil dari kolom tabel alamat_pasien ke dalam text field _alamat
                _umur.setText(rs.getString(4));//menampilkan teks yang diambil dari kolom tabel umur_pasien ke dalam text field _umur
                _dokter.setText(rs.getString(5));//menampilkan teks yang diambil dari kolom tabel dokter_spesialis ke dalam text field _dokter
                _spesialis.setText(rs.getString(6));//menampilkan teks yang diambil dari kolom tabel spesialis ke dalam text field _spesialis
                _namadokter.setText(rs.getString(7));//menampilkan teks yang diambil dari kolom tabel nama_dokter ke dalam text field _namadokter
                _ruangan.setText(rs.getString(8));//menampilkan teks yang diambil dari kolom tabel ruangan ke dalam text field _ruangan
            }
        }
        catch (Exception e){
    ...
    private void initComponents() {
        ...
        btn_edit.setFont(new java.awt.Font("Shruti", 1, 14)); // NOI18N
        ...
        btn_hapus.setFont(new java.awt.Font("Shruti", 1, 14)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(270, 270, 270)
                                .addComponent(btn_edit, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btn_kembali, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btn_hapus, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        //untuk masuk ke halaman edit_pasien
        dispose();
        String[] args = {no_pendaftaran};
        edit_pasien.main(args);
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        try
        {
            //code untuk menghapus data di table data_pasien berdasarkan primary key (no_pendaftaran) yang dipilih
            String sql ="DELETE FROM data_pasien WHERE no_pendaftaran='"+no_pendaftaran+"'";
            PreparedStatement statement = connection.prepareStatement(sql);
            statement.executeUpdate();
            JOptionPane.showMessageDialog(this, "Berhasil menghapus"); //pesan yg keluar jika proses sukses
            //jika proses selesai akan masuk ke halaman data_pasien
            dispose();
    ...
    private void btn_kembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_kembaliActionPerformed
        // TODO add your handling code here:
        //untuk masuk ke halaman data_pasien jika menekan tombol kembali
        dispose();
        new data_pasien().setVisible(true);
